...
public class EndConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> SCATTERED_ANCIENT_SCRAP = register("scattered_ancient_scrap", EndFeatures.SCATTERED_ORE.configure(new SingleStateFeatureConfig(EndBlocks.ANCIENT_SCRAP_BLOCK.getDefaultState())).uniformRange(YOffset.getBottom(), YOffset.fixed(60)).spreadHorizontally().applyChance(2));
    ...
    public static final ConfiguredFeature<?, ?> SCRAP_PILE = register("scrap_pile", Feature.BLOCK_PILE.configure(new BlockPileFeatureConfig(new SimpleBlockStateProvider(EndBlocks.ANCIENT_SCRAP_BLOCK.getDefaultState()))).uniformRange(YOffset.fixed(50), YOffset.fixed(70)).spreadHorizontally().applyChance(6));
    public static final ConfiguredFeature<?, ?> SCRAP_PILLARS = register("scrap_pillars", EndFeatures.SCRAP_PILLARS.configure(FeatureConfig.DEFAULT).uniformRange(YOffset.fixed(50), YOffset.fixed(70)).spreadHorizontally().repeat(30).applyChance(5));
