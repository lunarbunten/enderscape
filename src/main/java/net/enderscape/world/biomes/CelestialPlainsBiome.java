...
public class CelestialPlainsBiome extends EnderscapeBiome {
    public CelestialPlainsBiome() {
        super("celestial_plains", createNoise(0, 0, 0.3F, 0, 0));
    }
    ...
    public Biome getBiome() {
        ...
        EndBiomeFeatures.addCelestialFeatures(builder, spawnSettings);
        ...
        return (new Biome.Builder())
                ...
                .effects((new BiomeEffects.Builder()
                        ...
                        .loopSound(loopSound)
                        .additionsSound(new BiomeAdditionsSound(additionsSound, 0.01))
                        .particleConfig(new BiomeParticleConfig(EndParticles.CELESTIAL_SPORES, util.getSporeCount())))
