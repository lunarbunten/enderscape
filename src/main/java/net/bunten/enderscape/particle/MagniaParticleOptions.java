...
public record MagniaParticleOptions(Supplier<ParticleType<MagniaParticleOptions>> particle, int color, int fadeColor, float colorFadeRate) implements ParticleOptions {
