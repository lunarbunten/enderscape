...
public class Rubblemite extends Monster {
    ...
    private static final EntityDataAccessor<State> DATA_STATE = SynchedEntityData.defineId(Rubblemite.class, EnderscapeEntityDataSerializers.RUBBLEMITE_STATE_SERIALIZER);
