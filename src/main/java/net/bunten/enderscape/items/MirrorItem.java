...
public class MirrorItem extends Item implements Vanishable {
    ...
    protected TranslatableText getMirrorID(ItemStack stack) {
        var value = MirrorUtil.getDimension(stack).getValue();
        return new TranslatableText("dimension." + value.getNamespace() + "." + value.getPath());
    }
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext ctx) {
        if (MirrorUtil.isLinked(stack)) {
            ...
            if (Screen.hasShiftDown()) {
                ...
                tooltip.add(new TranslatableText("item.enderscape.mirror.desc.dimension", getMirrorID(stack)).formatted(Formatting.DARK_GREEN));
            } else {
