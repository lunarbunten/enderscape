...
public class EnderscapeItemTagProvider extends FabricTagProvider<Item> {
    ...
    protected void addTags(HolderLookup.Provider lookup) {
        getOrCreateTagBuilder(WEAK_MAGNIA_STRENGTH).add(
                CHAINMAIL_HELMET,
        ...
        getOrCreateTagBuilder(AVERAGE_MAGNIA_STRENGTH).add(
                IRON_HELMET,
                IRON_CHESTPLATE,
                IRON_LEGGINGS,
                IRON_BOOTS,
        ...
        getOrCreateTagBuilder(STRONG_MAGNIA_STRENGTH);

        getOrCreateTagBuilder(DAGGER_ENCHANTABLE).add(DAGGER);
        ...
        getOrCreateTagBuilder(NEBULITE_TOOLS).add(DAGGER, MIRROR, MAGNIA_ATTRACTOR);
        getOrCreateTagBuilder(NEBULITE_TOOL_ENCHANTABLE).forceAddTag(NEBULITE_TOOLS);
        getOrCreateTagBuilder(NEBULITE_TOOL_FUELS).add(NEBULITE);
        ...
        getOrCreateTagBuilder(REPAIRS_SHADOLINE_ARMOR).add(SHADOLINE_INGOT);
        ...
        getOrCreateTagBuilder(RUSTLE_FOOD).add(MURUBLIGHT_BRACKET_ITEM);

        getOrCreateTagBuilder(DUSK_PURPUR_BLOCKS).add(DUSK_PURPUR_BLOCK.asItem(), DUSK_PURPUR_PILLAR.asItem(), DUSK_PURPUR_STAIRS.asItem(), DUSK_PURPUR_SLAB.asItem(), DUSK_PURPUR_WALL.asItem(), CHISELED_DUSK_PURPUR.asItem());
        getOrCreateTagBuilder(END_ORE_BLOCKS).add(NEBULITE_ORE.asItem(), SHADOLINE_ORE.asItem(), MIRESTONE_NEBULITE_ORE.asItem(), MIRESTONE_SHADOLINE_ORE.asItem());
        ...
        getOrCreateTagBuilder(NEW_PURPUR_BLOCKS).add(
                CHISELED_PURPUR.asItem(),
                PURPUR_WALL.asItem()
        );

        getOrCreateTagBuilder(OVERGROWTH_BLOCKS).add(
                CELESTIAL_OVERGROWTH.asItem(),
                CORRUPT_OVERGROWTH.asItem()
        );

        getOrCreateTagBuilder(PURPUR_TILE_BLOCKS).add(
                PURPUR_TILES.asItem(),
        ...
        getOrCreateTagBuilder(CELESTIAL_WOOD_ITEMS).forceAddTag(CELESTIAL_STEMS).add(
        ...
        getOrCreateTagBuilder(VEILED_WOOD_ITEMS).forceAddTag(VEILED_LOGS).add(
        ...
        getOrCreateTagBuilder(MURUBLIGHT_WOOD_ITEMS).forceAddTag(MURUBLIGHT_STEMS).add(
        ...
        getOrCreateTagBuilder(ALL_ETCHED_MAGNIA_BLOCKS).addTag(ETCHED_ALLURING_MAGNIA_BLOCKS).addTag(ETCHED_REPULSIVE_MAGNIA_BLOCKS);

        getOrCreateTagBuilder(ETCHED_ALLURING_MAGNIA_BLOCKS).add(
        ...
        getOrCreateTagBuilder(ETCHED_REPULSIVE_MAGNIA_BLOCKS).add(
        ...
        getOrCreateTagBuilder(CHEST_ARMOR).add(SHADOLINE_CHESTPLATE);
        ...
        getOrCreateTagBuilder(FIRE_ASPECT_ENCHANTABLE).add(DAGGER);
        getOrCreateTagBuilder(FOOT_ARMOR).add(SHADOLINE_BOOTS);
        ...
        getOrCreateTagBuilder(HEAD_ARMOR).add(SHADOLINE_HELMET);
        getOrCreateTagBuilder(ItemTags.FENCE_GATES).add(CELESTIAL_FENCE_GATE.asItem(), MURUBLIGHT_FENCE_GATE.asItem());
        getOrCreateTagBuilder(ItemTags.TALL_FLOWERS).add(WISP_FLOWER.asItem());
        getOrCreateTagBuilder(ItemTags.FLOWERS).add(FLANGER_BERRY_FLOWER.asItem());
        ...
        getOrCreateTagBuilder(LEG_ARMOR).add(SHADOLINE_LEGGINGS, DRIFT_LEGGINGS);
        ...
        getOrCreateTagBuilder(SWEEPING_EDGE_INCOMPATIBLE).add(DAGGER);
        getOrCreateTagBuilder(SWORD_ENCHANTABLE).add(DAGGER);
        getOrCreateTagBuilder(TRIMMABLE_ARMOR).add(SHADOLINE_HELMET, SHADOLINE_CHESTPLATE, SHADOLINE_LEGGINGS, SHADOLINE_BOOTS, DRIFT_LEGGINGS);
        ...
        getOrCreateTagBuilder(externalKey("item_tooltips", "has_description")).add(MAGNIA_ATTRACTOR, DRIFT_LEGGINGS, DRIFT_JELLY_BOTTLE, DRIFT_JELLY_BLOCK.asItem(), NEBULITE).addTag(RUBBLE_SHIELDS);

        // Common Tags

        getOrCreateTagBuilder(BERRY_FOODS).add(FLANGER_BERRY);
        getOrCreateTagBuilder(BUCKETS).add(RUSTLE_BUCKET);
        getOrCreateTagBuilder(ConventionalItemTags.CHAINS).add(SHADOLINE_CHAIN.asItem());
        ...
        getOrCreateTagBuilder(NUGGETS).add(SHADOLINE_NUGGET);
        ...
        getOrCreateTagBuilder(NEBULITE_GEMS).add(NEBULITE);
        getOrCreateTagBuilder(NEBULITE_ORES).add(NEBULITE_ORE.asItem(), MIRESTONE_NEBULITE_ORE.asItem());
        getOrCreateTagBuilder(NEBULITE_STORAGE_BLOCKS).add(NEBULITE_BLOCK.asItem());
        getOrCreateTagBuilder(RAW_MATERIALS).add(RAW_SHADOLINE);
        getOrCreateTagBuilder(RAW_SHADOLINE_STORAGE_BLOCKS).add(RAW_SHADOLINE_BLOCK.asItem());
        getOrCreateTagBuilder(SHADOLINE_INGOTS).add(SHADOLINE_INGOT);
        getOrCreateTagBuilder(SHADOLINE_NUGGETS).add(SHADOLINE_NUGGET);
        getOrCreateTagBuilder(SHADOLINE_ORES).add(SHADOLINE_ORE.asItem(), MIRESTONE_SHADOLINE_ORE.asItem());
        getOrCreateTagBuilder(SHADOLINE_RAW_MATERIALS).add(RAW_SHADOLINE);
        getOrCreateTagBuilder(SHADOLINE_STORAGE_BLOCKS).add(SHADOLINE_BLOCK.asItem());
