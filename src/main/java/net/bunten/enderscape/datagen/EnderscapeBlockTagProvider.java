...
public class EnderscapeBlockTagProvider extends FabricTagProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider lookup) {
        getOrCreateTagBuilder(ALL_ETCHED_MAGNIA_BLOCKS).forceAddTag(ETCHED_ALLURING_MAGNIA_BLOCKS).forceAddTag(ETCHED_REPULSIVE_MAGNIA_BLOCKS);
        ...
        getOrCreateTagBuilder(RUBBLEMITE_MIRESTONE_VARIANTS_SPAWN_ON).forceAddTag(MIRESTONE_BLOCKS).forceAddTag(DUSK_PURPUR_BLOCKS).add(CORRUPT_OVERGROWTH);
        ...
        getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_PICKAXE)
                .forceAddTag(
                        ALL_ETCHED_MAGNIA_BLOCKS).forceAddTag(
                        CHANTERELLE_BRICK_BLOCKS).forceAddTag(
                        DUSK_PURPUR_BLOCKS).forceAddTag(
                        END_ORE_BLOCKS).forceAddTag(
                        KURODITE_BLOCKS).forceAddTag(
                        MAGNIA_BLOCKS).forceAddTag(
                        MAGNIA_SPROUTS).forceAddTag(
                        MIRESTONE_BLOCKS).forceAddTag(
                        NEW_END_STONE_BLOCKS).forceAddTag(
                        NEW_PURPUR_BLOCKS).forceAddTag(
                        OVERGROWTH_BLOCKS).forceAddTag(
                        PURPUR_TILE_BLOCKS).forceAddTag(
                        SHADOLINE_BLOCKS).forceAddTag(
                        VERADITE_BLOCKS
                )
                .add(
                        BLINKLAMP,
        ...
        getOrCreateTagBuilder(BlockTags.CAMPFIRES).add(VOID_CAMPFIRE);
        ...
        getOrCreateTagBuilder(BlockTags.WALL_POST_OVERRIDE).add(VOID_TORCH);
