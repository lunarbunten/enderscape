...
public class EnderscapeBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void addTags(HolderLookup.Provider lookup) {
        valueLookupBuilder(BLOCKS_ALLURING_MAGNIA_SPROUTS).add(REPULSIVE_MAGNIA, ETCHED_REPULSIVE_MAGNIA);
        valueLookupBuilder(BLOCKS_REPULSIVE_MAGNIA_SPROUTS).add(ALLURING_MAGNIA, ETCHED_ALLURING_MAGNIA);
        ...
        valueLookupBuilder(CELESTIAL_WOOD).forceAddTag(CELESTIAL_STEMS).add(CELESTIAL_PLANKS, CELESTIAL_SLAB, CELESTIAL_STAIRS, CELESTIAL_FENCE, CELESTIAL_FENCE_GATE, CELESTIAL_BUTTON, CELESTIAL_SIGN, CELESTIAL_HANGING_SIGN, CELESTIAL_WALL_SIGN, CELESTIAL_WALL_HANGING_SIGN);
        ...
        valueLookupBuilder(ENDERMITE_SAFE_WHEN_NEARBY).add(CORRUPT_OVERGROWTH, CORRUPT_PATH_BLOCK, CORRUPT_GROWTH, POTTED_CORRUPT_GROWTH);
        valueLookupBuilder(END_ORE_BLOCKS).add(NEBULITE_ORE, SHADOLINE_ORE, MIRESTONE_NEBULITE_ORE, MIRESTONE_SHADOLINE_ORE);
        valueLookupBuilder(ETCHED_MAGNIA_BLOCKS).add(ETCHED_ALLURING_MAGNIA, ETCHED_REPULSIVE_MAGNIA);
        ...
        valueLookupBuilder(KURODITE_BLOCKS).add(CHISELED_KURODITE, POLISHED_KURODITE_BUTTON, POLISHED_KURODITE_PRESSURE_PLATE);
        valueLookupBuilder(KURODITE_BLOCKS).add(KURODITE, KURODITE_SLAB, KURODITE_STAIRS, KURODITE_WALL);
        valueLookupBuilder(KURODITE_BLOCKS).add(KURODITE_BRICKS, KURODITE_BRICK_SLAB, KURODITE_BRICK_STAIRS, KURODITE_BRICK_WALL);
        valueLookupBuilder(KURODITE_BLOCKS).add(POLISHED_KURODITE, POLISHED_KURODITE_SLAB, POLISHED_KURODITE_STAIRS, POLISHED_KURODITE_WALL);
        ...
        valueLookupBuilder(MIRESTONE_BLOCKS).add(CHISELED_MIRESTONE, POLISHED_MIRESTONE_BUTTON, POLISHED_MIRESTONE_PRESSURE_PLATE);
        valueLookupBuilder(MIRESTONE_BLOCKS).add(MIRESTONE, MIRESTONE_SLAB, MIRESTONE_STAIRS, MIRESTONE_WALL);
        valueLookupBuilder(MIRESTONE_BLOCKS).add(MIRESTONE_BRICKS, MIRESTONE_BRICK_SLAB, MIRESTONE_BRICK_STAIRS, MIRESTONE_BRICK_WALL);
        valueLookupBuilder(MIRESTONE_BLOCKS).add(POLISHED_MIRESTONE, POLISHED_MIRESTONE_SLAB, POLISHED_MIRESTONE_STAIRS, POLISHED_MIRESTONE_WALL);
        ...
        valueLookupBuilder(MURUBLIGHT_WOOD).forceAddTag(MURUBLIGHT_STEMS).add(MURUBLIGHT_PLANKS, MURUBLIGHT_SLAB, MURUBLIGHT_STAIRS, MURUBLIGHT_FENCE, MURUBLIGHT_FENCE_GATE, MURUBLIGHT_BUTTON, MURUBLIGHT_SIGN, MURUBLIGHT_HANGING_SIGN, MURUBLIGHT_WALL_SIGN, MURUBLIGHT_WALL_HANGING_SIGN);
        ...
        valueLookupBuilder(NEW_END_STONE_BLOCKS).add(CHISELED_END_STONE, POLISHED_END_STONE_BUTTON, POLISHED_END_STONE_PRESSURE_PLATE);
        valueLookupBuilder(NEW_END_STONE_BLOCKS).add(END_STONE_SLAB, END_STONE_STAIRS, END_STONE_WALL);
        valueLookupBuilder(NEW_END_STONE_BLOCKS).add(POLISHED_END_STONE, POLISHED_END_STONE_SLAB, POLISHED_END_STONE_STAIRS, POLISHED_END_STONE_WALL);
        valueLookupBuilder(NEW_PURPUR_BLOCKS).add(PURPUR_WALL, CHISELED_PURPUR);
        ...
        valueLookupBuilder(SHADOLINE_BLOCKS).add(CHISELED_SHADOLINE, SHADOLINE_PILLAR);
        valueLookupBuilder(SHADOLINE_BLOCKS).add(CUT_SHADOLINE, CUT_SHADOLINE_SLAB, CUT_SHADOLINE_STAIRS, CUT_SHADOLINE_WALL);
        valueLookupBuilder(SHADOLINE_BLOCKS).add(SHADOLINE_BLOCK, SHADOLINE_BLOCK_SLAB, SHADOLINE_BLOCK_STAIRS, SHADOLINE_BLOCK_WALL);
        ...
        valueLookupBuilder(VEILED_WOOD_TAG).forceAddTag(VEILED_LOGS).add(VEILED_PLANKS, VEILED_SLAB, VEILED_STAIRS, VEILED_FENCE, VEILED_FENCE_GATE, VEILED_BUTTON, VEILED_SIGN, VEILED_HANGING_SIGN, VEILED_WALL_SIGN, VEILED_WALL_HANGING_SIGN);
        valueLookupBuilder(VERADITE_BLOCKS).add(CHISELED_VERADITE, POLISHED_VERADITE_BUTTON, POLISHED_VERADITE_PRESSURE_PLATE);
        valueLookupBuilder(VERADITE_BLOCKS).add(POLISHED_VERADITE, POLISHED_VERADITE_SLAB, POLISHED_VERADITE_STAIRS, POLISHED_VERADITE_WALL);
        valueLookupBuilder(VERADITE_BLOCKS).add(VERADITE, VERADITE_SLAB, VERADITE_STAIRS, VERADITE_WALL);
        valueLookupBuilder(VERADITE_BLOCKS).add(VERADITE_BRICKS, VERADITE_BRICK_SLAB, VERADITE_BRICK_STAIRS, VERADITE_BRICK_WALL);
        ...
        valueLookupBuilder(BlockTags.CLIMBABLE).add(BLINKLIGHT_VINES_BODY, BLINKLIGHT_VINES_HEAD, FLANGER_BERRY_VINE, MURUBLIGHT_SHELF, VEILED_VINES);
        ...
        valueLookupBuilder(BlockTags.FLOWERS).add(WISP_FLOWER);
        valueLookupBuilder(BlockTags.FLOWER_POTS).add(POTTED_ALLURING_MAGNIA_SPROUT, POTTED_BLINKLIGHT, POTTED_BULB_FLOWER, POTTED_CELESTIAL_CHANTERELLE, POTTED_CELESTIAL_GROWTH, POTTED_CHORUS_SPROUTS, POTTED_CORRUPT_GROWTH, POTTED_MURUBLIGHT_CHANTERELLE, POTTED_REPULSIVE_MAGNIA_SPROUT, POTTED_DRY_END_GROWTH, POTTED_VEILED_SAPLING, POTTED_WISP_GROWTH);
        valueLookupBuilder(BlockTags.LEAVES).add(VEILED_LEAVES);
        valueLookupBuilder(BlockTags.LOGS_THAT_BURN).forceAddTag(VEILED_LOGS).forceAddTag(CELESTIAL_STEMS).forceAddTag(MURUBLIGHT_STEMS);
        ...
        valueLookupBuilder(BlockTags.NEEDS_STONE_TOOL).add(SHADOLINE_ORE, MIRESTONE_SHADOLINE_ORE).forceAddTag(SHADOLINE_BLOCKS).forceAddTag(MAGNIA_BLOCKS).forceAddTag(MAGNIA_SPROUTS);
        ...
        valueLookupBuilder(externalKey("create", "tree_attachments")).add(MURUBLIGHT_SHELF);
        valueLookupBuilder(externalKey("create", "tree_roots")).add(VEILED_LOG, VEILED_WOOD);
        valueLookupBuilder(externalKey("create", "wrench_pickup")).add(BLINKLAMP, ALLURING_MAGNIA_SPROUT, REPULSIVE_MAGNIA_SPROUT);
    }
