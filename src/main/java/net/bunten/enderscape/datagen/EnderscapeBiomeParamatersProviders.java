...
public class EnderscapeBiomeParamatersProviders extends FabricDynamicRegistryProvider {
    public EnderscapeBiomeParamatersProviders(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> future) {
        super(output, future);
    }
