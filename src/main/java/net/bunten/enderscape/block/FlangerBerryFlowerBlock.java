...
public class FlangerBerryFlowerBlock extends Block implements BonemealableBlock {
    ...
    private boolean attachedToVine(LevelReader world, BlockPos pos) {
        return world.getBlockState(pos.above()).is(EnderscapeBlocks.FLANGER_BERRY_VINE);
    }
    ...
    public void performBonemeal(ServerLevel world, RandomSource random, BlockPos pos, BlockState state) {
        BlockState unripe = EnderscapeBlocks.UNRIPE_FLANGER_BERRY_BLOCK.defaultBlockState();
