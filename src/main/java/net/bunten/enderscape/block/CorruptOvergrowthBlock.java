...
public class CorruptOvergrowthBlock extends AbstractOvergrowthBlock {
    ...
    public CorruptOvergrowthBlock(BlockBehaviour.Properties settings) {
        super(false, EnderscapeBlocks.MIRESTONE, EnderscapeBlocks.CORRUPT_PATH_BLOCK, EnderscapeBlockSounds.CORRUPT_OVERGROWTH_FLATTEN, DirectionProperties.create().all(), settings);
    }
