...
public class EnderscapeBiomeParameters {
    ...
    public void bootstrap(BootstrapContext<BiomeParameters> context) {
        ...
        register(context,
                VOID_SKIES,
                RGBA.darkenColor(DEFAULT_NEBULA_COLOR, VOID_BIOMES_DARKENING_FACTOR),
                DEFAULT_NEBULA_ALPHA,
                RGBA.darkenColor(DEFAULT_STAR_COLOR, VOID_BIOMES_DARKENING_FACTOR),
                DEFAULT_STAR_ALPHA,
                0x000000,
    ...
    private static ResourceKey<BiomeParameters> register(ResourceLocation location) {
        ResourceKey<BiomeParameters> key = ResourceKey.create(EnderscapeRegistries.BIOME_PARAMETERS_KEY, location);
