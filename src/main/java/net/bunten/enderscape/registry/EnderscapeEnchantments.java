    ...
    public void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, TRANSDIMENSIONAL,
                Enchantment.enchantment(
                        ...
                        EnderscapeEnchantmentEffectComponents.LODESTONE_TELEPORTATION_ENABLE_TRANSDIMENSIONAL.get(),
        ...
        register(context, RESONANCE,
                Enchantment.enchantment(
                        ...
                        EnderscapeEnchantmentEffectComponents.LODESTONE_TELEPORTATION_DISTANCE_TO_INCREASE_COST.get(),
                        new AddValue(LevelBasedValue.perLevel(250))
                ).withEffect(
                        EnderscapeEnchantmentEffectComponents.INTEGER_COUNTER_THRESHOLD.get(),
                        new AddValue(LevelBasedValue.perLevel(100)),
                        MatchTool.toolMatches(ItemPredicate.Builder.item().of(EnderscapeItems.MAGNIA_ATTRACTOR.get()))
                ).withEffect(
                        EnderscapeEnchantmentEffectComponents.INTEGER_COUNTER_THRESHOLD.get(),
                        new AddValue(LevelBasedValue.perLevel(2)),
                        MatchTool.toolMatches(ItemPredicate.Builder.item().of(EnderscapeItems.DAGGER.get()))
                )
        );
    }
