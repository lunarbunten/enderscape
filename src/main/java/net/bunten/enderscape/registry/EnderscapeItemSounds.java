...
public class EnderscapeItemSounds {
    ...
    public static final Holder<SoundEvent> DAGGER_ATTACK_STRONG = registerHolder("dagger.attack.strong");
    public static final Holder<SoundEvent> DAGGER_ATTACK_CRIT = registerHolder("dagger.attack.crit");
    public static final Holder<SoundEvent> DAGGER_ATTACK_KNOCKBACK = registerHolder("dagger.attack.knockback");
    public static final Holder<SoundEvent> DAGGER_BACKSTAB = registerHolder("dagger.backstab");
    public static final Holder<SoundEvent> DAGGER_STUN = registerHolder("dagger.stun");
    public static final Holder<SoundEvent> ELYTRA_EQUIP = registerHolder("elytra.equip");
    public static final Holder<SoundEvent> MAGNIA_ATTRACTOR_MOVE = registerHolder("magnia_attractor.move");
    public static final Holder<SoundEvent> MAGNIA_ATTRACTOR_POWER_OFF = registerHolder("magnia_attractor.power_off");
    public static final Holder<SoundEvent> MAGNIA_ATTRACTOR_POWER_ON = registerHolder("magnia_attractor.power_on");
    public static final Holder<SoundEvent> MAGNIA_ATTRACTOR_USE_FUEL = registerHolder("magnia_attractor.use_fuel");
    public static final Holder<SoundEvent> MIRROR_FAILURE = registerHolder("mirror.failure");
    public static final Holder<SoundEvent> MIRROR_LINK = registerHolder("mirror.link");
    public static final Holder<SoundEvent> MIRROR_TELEPORT = registerHolder("mirror.teleport");
    public static final Holder<SoundEvent> MIRROR_TRANSDIMENSIONAL_TRAVEL = registerHolder("mirror.transdimensional_travel");
    public static final Holder<SoundEvent> NEBULITE_TOOL_ADD_FUEL = registerHolder("nebulite_tool.add_fuel");
    public static final Holder<SoundEvent> NEBULITE_TOOL_FUEL_FULL = registerHolder("nebulite_tool.fuel_full");
    public static final Holder<SoundEvent> RUBBLE_SHIELD_BLOCK = registerHolder("rubble_shield.block");
    ...
    public static final Holder<SoundEvent> SHADOLINE_ARMOR_EQUIP = registerHolder("shadoline_armor.equip");
