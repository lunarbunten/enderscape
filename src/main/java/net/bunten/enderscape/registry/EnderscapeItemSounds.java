...
public class EnderscapeItemSounds {
    ...
    public static final SoundEvent MAGNIA_ATTRACTOR_MOVE = register("magnia_attractor.move");
    public static final SoundEvent MAGNIA_ATTRACTOR_POWER_OFF = register("magnia_attractor.power_off");
    public static final SoundEvent MAGNIA_ATTRACTOR_POWER_ON = register("magnia_attractor.power_on");
    public static final SoundEvent MAGNIA_ATTRACTOR_USE_FUEL = register("magnia_attractor.use_fuel");
    public static final SoundEvent MIRROR_FAILURE = register("mirror.failure");
    public static final SoundEvent MIRROR_LINK = register("mirror.link");
    public static final SoundEvent MIRROR_TELEPORT = register("mirror.teleport");
    public static final SoundEvent MIRROR_TRANSDIMENSIONAL_TRAVEL = register("mirror.transdimensional_travel");
    public static final SoundEvent NEBULITE_TOOL_ADD_FUEL = register("nebulite_tool.add_fuel");
    public static final SoundEvent NEBULITE_TOOL_FUEL_FULL = register("nebulite_tool.fuel_full");
    public static final SoundEvent RUBBLE_SHIELD_BLOCK = register("rubble_shield.block");
