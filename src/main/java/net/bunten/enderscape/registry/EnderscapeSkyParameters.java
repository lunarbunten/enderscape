...
public class EnderscapeSkyParameters {
    ...
    public static void bootstrap(BootstrapContext<SkyParameters> context) {
        ...
        register(context, CORRUPT_BARRENS, 0x555189, DEFAULT_NEBULA_ALPHA * 0.8F, 0x9F89FF, DEFAULT_STAR_ALPHA * 0.7F, 4.0F, 1.25F);

        register(context, MAGNIA_FIELDS, 0x96AD9E, DEFAULT_NEBULA_ALPHA * 0.5F, 0x89FFD5, DEFAULT_STAR_ALPHA * 0.85F, 1.0F, 1.0F);
