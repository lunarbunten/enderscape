...
public class EnderscapeSkyParameters {
    ...
    public static void bootstrap(BootstrapContext<SkyParameters> context) {
        ...
        register(context, CORRUPT_BARRENS, RGBA.darkenColor(DEFAULT_NEBULA_COLOR, CORRUPT_BARRENS_DARKENING_FACTOR), DEFAULT_NEBULA_ALPHA, RGBA.darkenColor(DEFAULT_NEBULA_COLOR, CORRUPT_BARRENS_DARKENING_FACTOR), DEFAULT_STAR_ALPHA, 0x00FF00FF, 4.0F, 1.25F);

        register(context, MAGNIA_CRAGS, 0x96AD9E, DEFAULT_NEBULA_ALPHA * 0.5F, 0x89FFD5, DEFAULT_STAR_ALPHA * 0.85F, DEFAULT_STAR_COLOR, 1.0F, 1.0F);
        register(context, VEILED_WOODLANDS, 0x969BAA, DEFAULT_NEBULA_ALPHA * 0.7F, 0xB493FF, DEFAULT_STAR_ALPHA, 0x0000FFFF, 4.0F, 1.0F);
