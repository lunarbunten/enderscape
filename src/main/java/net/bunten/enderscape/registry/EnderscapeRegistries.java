...
public class EnderscapeRegistries {
    ...
    public static final ResourceKey<Registry<RubblemiteVariant>> RUBBLEMITE_VARIANT = ResourceKey.createRegistryKey(ResourceLocation.withDefaultNamespace("enderscape/rubblemite_variant"));
