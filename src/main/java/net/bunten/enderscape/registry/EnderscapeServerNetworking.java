...
public class EnderscapeServerNetworking {
    ...
    public static void register(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(ClientboundLodestoneTeleportationInfoPayload.TYPE, ClientboundLodestoneTeleportationInfoPayload.STREAM_CODEC, (payload, ctx) -> EnderscapeClientNetworking.receiveLodestoneTeleportationInfoPayload(payload, ctx));
