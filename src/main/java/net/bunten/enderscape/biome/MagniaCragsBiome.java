...
public class MagniaCragsBiome {
    ...
    public static Biome create(BootstrapContext<Biome> context) {
        ...
        MobSpawnSettings.Builder spawns = new MobSpawnSettings.Builder().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EnderscapeEntities.RUBBLEMITE.get(), 2, 2, 3));
