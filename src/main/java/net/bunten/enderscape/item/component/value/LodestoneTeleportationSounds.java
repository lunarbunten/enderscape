...
public record LodestoneTeleportationSounds(
    ...
    public static final Holder<SoundEvent> DEFAULT_LINK_SOUND = EnderscapeItemSounds.MIRROR_LINK;
    public static final Holder<SoundEvent> DEFAULT_TELEPORT_FAILURE = EnderscapeItemSounds.MIRROR_FAILURE;
    public static final Holder<SoundEvent> DEFAULT_TELEPORT_SUCCESS = EnderscapeItemSounds.MIRROR_TELEPORT;
    public static final Holder<SoundEvent> DEFAULT_TRANSDIMENSIONAL_TRAVEL = EnderscapeItemSounds.MIRROR_TRANSDIMENSIONAL_TRAVEL;
