...
public record LodestoneTeleportationCost(
    ...
    public static final LodestoneTeleportationCost DEFAULT = LodestoneTeleportationCost.Builder.create().build();
    ...
    public static class Builder {
        ...
        public static LodestoneTeleportationCost.Builder create() {
            return new LodestoneTeleportationCost.Builder();
        }
