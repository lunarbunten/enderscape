...
public class LodestoneTrackerContext extends ItemStackContext {

    public LodestoneTrackerContext(ItemStack stack, Level level, LivingEntity user) {
        super(stack, level, user);
    }

    public static LodestoneTrackerContext of(ItemStackContext context) {
        return new LodestoneTrackerContext(context.stack(), context.level(), context.user());
    }
