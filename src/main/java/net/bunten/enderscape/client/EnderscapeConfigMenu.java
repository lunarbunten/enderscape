...
public class EnderscapeConfigMenu {
    ...
    public static Screen buildMenu(ModContainer client, Screen parent) {
        return YetAnotherConfigLib.create(
                EnderscapeConfig.HANDLER, (defaults, config, builder) -> builder.title(Component.translatable("menu.enderscape.config"))
                        .category(EnderscapeConfigMenu.createMainCategory(config))
                        .category(EnderscapeConfigMenu.createClientsideCategory(config))
    ...
    private static void addServersideBlockOptions(EnderscapeConfig config, ConfigCategory.Builder builder) {
        Option<?> blockSoundsUpdateChorus = boolOption(
                ...
                true,
                () -> config.blockSoundUpdateChorus,
                value -> config.blockSoundUpdateChorus = value,
                TickBoxControllerBuilder::create
        );
        ...
        Option<?> blocksSoundUpdatePurpur = boolOption(
                ...
                true,
                () -> config.blockSoundUpdatePurpur,
                value -> config.blockSoundUpdatePurpur = value,
                TickBoxControllerBuilder::create
        );
        ...
        Option<?> blockSoundsUpdateEndRods = boolOption(
                ...
                true,
                () -> config.blockSoundUpdateEndRods,
                value -> config.blockSoundUpdateEndRods = value,
                TickBoxControllerBuilder::create
        );
