...
public class NebuliteToolHud extends HudElement {
    ...
    public void render(GuiGraphics graphics, DeltaTracker delta) {
        if (!config.nebuliteToolHudEnabled || client.player == null || client.options.hideGui || totalAlpha <= 0.01F || !client.options.getCameraType().isFirstPerson() || client.player.isSpectator()) {
            return;
        }
