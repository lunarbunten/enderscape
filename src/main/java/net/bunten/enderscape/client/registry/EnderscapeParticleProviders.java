...
public class EnderscapeParticleProviders {
    ...
    static {
        ParticleFactoryRegistry.getInstance().register(ALLURING_MAGNIA, AlluringMagniaParticle.Provider::new);
        ...
        ParticleFactoryRegistry.getInstance().register(REPULSIVE_MAGNIA, RepulsiveMagniaParticle.Provider::new);
