...
import static net.penumbra.enderscape.registry.component.EnderscapeDataComponents.TOGGLABLE;
...
public record Togglable(
    ...
    public static InteractionResult use(Level level, Player player, InteractionHand hand) {
        return tryToggle(new ItemStackContext(player.getItemInHand(hand), level, player)) ? InteractionResult.CONSUME : InteractionResult.PASS;
    }
