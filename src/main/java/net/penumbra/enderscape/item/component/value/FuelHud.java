...
public record FuelHud(
    ...
    private static final Identifier DEFAULT_EMPTY_SEGMENTS = Enderscape.id("nebulite_tool/hud/empty_segments");
    private static final Identifier DEFAULT_FUELED_SEGMENTS = Enderscape.id("nebulite_tool/hud/fueled_segments");
    private static final Identifier DEFAULT_INVALID_OVERLAY_SEGMENTS = Enderscape.id("nebulite_tool/hud/invalid_overlay_segments");
    private static final Identifier DEFAULT_OUTLINE = Enderscape.id("nebulite_tool/hud/transdimensional_outline");
    private static final Identifier DEFAULT_COST_OVERLAY_SEGMENT = Enderscape.id("nebulite_tool/hud/cost_overlay_segment");
