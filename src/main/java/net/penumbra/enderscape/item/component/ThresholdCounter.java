...
import static net.penumbra.enderscape.registry.component.EnderscapeDataComponents.THRESHOLD_COUNTER;
...
public record ThresholdCounter(
    ...
    public static int modifyThreshold(ServerLevel level, ItemStack stack, float value) {
        ...
        EnchantmentHelper.runIterationOnItem(stack, (holder, i) -> holder.value().modifyItemFilteredCount(EnderscapeEnchantmentEffectComponents.INTEGER_COUNTER_THRESHOLD, level, i, stack, mutable));
