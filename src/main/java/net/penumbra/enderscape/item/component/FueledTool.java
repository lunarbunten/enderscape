...
import net.penumbra.enderscape.item.component.value.FuelTooltip;
...
public record FueledTool(
    ...
    private static final TagKey<Item> DEFAULT_FUELS = EnderscapeItemTags.NEBULITE_TOOL_FUELS;
    private static final int DEFAULT_FUEL_PER_USE = 1;
    private static final FuelDisplay DEFAULT_FUEL_DISPLAY = FuelDisplay.DEFAULT;
    private static final FuelSounds DEFAULT_FUEL_SOUNDS = FuelSounds.DEFAULT;
    ...
    public static void useFuelOrDamage(ItemStackContext context, int durabilityDamageAmount, EquipmentSlot slot) {
        ItemStack stack = context.stack();
        ...
        if (FueledTool.is(stack)) {
            ...
            stack.hurtAndBreak(durabilityDamageAmount, user, slot);
        }
    }
