...
public class EnderscapeMemory extends MemoryModuleType<Object> {
    ...
    public static final MemoryModuleType<LivingEntity> NEAREST_INTIMIDATOR = register("nearest_intimidator");
    ...
    public static final MemoryModuleType<Boolean> RUSTLE_IS_CONVERTING = register("rustle_is_converting", Codec.BOOL);
    ...
    protected static <U> MemoryModuleType<U> register(String string, Codec<U> codec) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, Enderscape.id(string), new MemoryModuleType<>(Optional.of(codec)));
    }

    protected static <U> MemoryModuleType<U> register(String string) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, Enderscape.id(string), new MemoryModuleType<>(Optional.empty()));
    }
}