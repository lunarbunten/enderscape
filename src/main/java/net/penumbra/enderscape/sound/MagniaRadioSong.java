...
public record MagniaRadioSong(Holder<SoundEvent> soundEvent, Component description, float lengthInSeconds, Optional<Integer> exclusiveSignal, Optional<TagKey<Biome>> permittedBiomes) {
    public static final Codec<MagniaRadioSong> DIRECT_CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    ...
                    ExtraCodecs.intRange(0, 15).optionalFieldOf("exclusive_signal").forGetter(MagniaRadioSong::exclusiveSignal),
                    TagKey.codec(Registries.BIOME).optionalFieldOf("permitted_biomes").forGetter(MagniaRadioSong::permittedBiomes)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MagniaRadioSong> DIRECT_STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.optional(TagKey.streamCodec(Registries.BIOME)),
