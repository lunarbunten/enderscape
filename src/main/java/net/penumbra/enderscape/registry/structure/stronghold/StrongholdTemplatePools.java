...
public class StrongholdTemplatePools extends EnderscapeTemplatePools {

    public static final ResourceKey<StructureTemplatePool> START = localized("start");
    public static final ResourceKey<StructureTemplatePool> SMALL_HALL_OR_UNIQUE_FALLBACK = localized("small_hall_or_unique_fallback");
    public static final ResourceKey<StructureTemplatePool> LARGE_HALL_FALLBACK = localized("large_hall_fallback");
    ...
    public static void bootstrap(BootstrapContext<StructureTemplatePool> context) {
        ...
        register(
                context,
                "large_hall_into_unique_without_chests",
                new StructureTemplatePool(
                        pools.getOrThrow(LARGE_HALL_FALLBACK),
                ...
                Pair.of(
                        (projection) -> new GuaranteedPoolElement(
                                StructurePoolElement.single(
                                        "enderscape:stronghold/end_portal",
                                        processors.getOrThrow(StrongholdProcessorLists.PORTAL_ROOM_DEGRADATION)).apply(projection),
                                Optional.empty(),
                                1
                        ), 1
                ),
