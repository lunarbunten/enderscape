...
public class EnderscapeItemSounds {
    ...
    public static final Holder.Reference<SoundEvent> DAGGER_STUN_BURST = registerHolder("dagger.stun_burst");
    public static final Holder.Reference<SoundEvent> DAGGER_STUN_MISS = registerHolder("dagger.stun_miss");
    ...
    public static final Holder.Reference<SoundEvent> GENERIC_VOID_PURIFY = registerHolder("generic.void_purify");
    ...
    public static final Holder.Reference<SoundEvent> RUSTLE_SILK_USE = registerHolder("rustle_silk.use");
    ...
    public static final SoundEvent TOTEM_OF_UNDYING_VOIDED = register("totem_of_undying.voided");
    public static final SoundEvent TRIDENT_WARP = register("trident.warp");
    public static final SoundEvent VOID_LACHRYMA_BUCKET_FILL = register("void_lachryma_bucket.fill");
    public static final SoundEvent VOID_LACHRYMA_BUCKET_EMPTY = register("void_lachryma_bucket.empty");
