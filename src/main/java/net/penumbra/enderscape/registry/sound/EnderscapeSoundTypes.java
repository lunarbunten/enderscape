...
public class EnderscapeSoundTypes {
    ...
    public static final SoundType END_HAVEN_CORE = registerSoundType("end_haven_core", 1, 1.2F);
    ...
    public static final SoundType PURUBERRY_BLOCK = registerSoundType("puruberry_block", 1, 1.2F);
    public static final SoundType PURUBERRY_VINE = registerSoundType("puruberry_vine", 1, 0.9F);
    public static final SoundType PURUBERRY_FLOWER = registerSoundType("puruberry_flower", 1, 0.9F);
