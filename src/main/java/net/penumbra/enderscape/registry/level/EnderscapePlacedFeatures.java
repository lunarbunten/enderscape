...
public class EnderscapePlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> COMMON_VOID_FIRE_ON_VOID_SHALE = register("common_void_fire_on_void_shale");
    public static final ResourceKey<PlacedFeature> COMMON_VOID_LAKES = register("common_void_lakes");
    ...
    public static final ResourceKey<PlacedFeature> UNCOMMON_VOID_LAKES = register("uncommon_void_lakes");
    ...
    public static final ResourceKey<PlacedFeature> VERY_COMMON_VOID_LAKES = register("very_common_void_lakes");
    public static final ResourceKey<PlacedFeature> VOID_FIRE_ON_KURODITE = register("void_fire_on_kurodite");
    public static final ResourceKey<PlacedFeature> VOID_FIRE_ON_VOID_SHALE = register("void_fire_on_void_shale");
    public static final ResourceKey<PlacedFeature> VOID_LAKES = register("void_lakes");
    ...
    public static final ResourceKey<PlacedFeature> WISP_FLOWERS = register("wisp_flowers");
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, VOID_FIRE_ON_KURODITE, get(context, EnderscapeConfiguredFeatures.VOID_FIRE),
                FULL_RANGE,
                CountOnEveryLayerPlacement.of(10),
                EnvironmentScanPlacement.scanningFor(Direction.DOWN, matchesBlocks(EnderscapeBlocks.KURODITE), ONLY_IN_AIR_PREDICATE, 12),
                RandomOffsetPlacement.vertical(ConstantInt.of(1)),
                BiomeFilter.biome()
        );

        PlacementUtils.register(context, VOID_FIRE_ON_VOID_SHALE, get(context, EnderscapeConfiguredFeatures.VOID_FIRE),
                FULL_RANGE,
                CountOnEveryLayerPlacement.of(10),
                EnvironmentScanPlacement.scanningFor(Direction.DOWN, matchesBlocks(EnderscapeBlocks.VOID_SHALE), ONLY_IN_AIR_PREDICATE, 12),
                RandomOffsetPlacement.vertical(ConstantInt.of(1)),
                BiomeFilter.biome()
        );

        PlacementUtils.register(context, COMMON_VOID_FIRE_ON_VOID_SHALE, get(context, EnderscapeConfiguredFeatures.VOID_FIRE),
                FULL_RANGE,
        ...
        defaultVoidLake(context, UNCOMMON_VOID_LAKES, 120);
        defaultVoidLake(context, VOID_LAKES, 60);
        defaultVoidLake(context, COMMON_VOID_LAKES, 20);
        defaultVoidLake(context, VERY_COMMON_VOID_LAKES, 5);
    ...
    private static void defaultVoidLake(BootstrapContext<PlacedFeature> context, ResourceKey<PlacedFeature> key, int onAverageEvery) {
        PlacementUtils.register(context, key, get(context, EnderscapeConfiguredFeatures.VOID_LAKE),
                FULL_RANGE,
                CountOnEveryLayerPlacement.of(1),
                RarityFilter.onAverageOnceEvery(onAverageEvery),
                BlockPredicateFilter.forPredicate(BlockPredicate.not(LithostitchedBlockPredicates.inStructure(8, 22))),
                EnvironmentScanPlacement.scanningFor(
                        Direction.DOWN,
                        BlockPredicate.anyOf(
                                matchesTag(EnderscapeBlockTags.BASE_STONE_END),
                                matchesTag(EnderscapeBlockTags.MAGNIA_BLOCKS),
                                matchesTag(EnderscapeBlockTags.OVERGROWTH_BLOCKS),
                                matchesBlocks(VEILED_END_STONE)
                        ),
    ...
    private static void registerVeiledWoodlands(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, WISP_FLOWERS, get(context, EnderscapeConfiguredFeatures.WISP_FLOWER),
                FULL_RANGE,
                BiomeFilter.biome(),
        ...
        PlacementUtils.register(context, VEILED_TREES, get(context, EnderscapeConfiguredFeatures.VEILED_TREE),
                ...
                BlockPredicateFilter.forPredicate(BlockPredicate.allOf(
                        BlockPredicate.not(LithostitchedBlockPredicates.inStructure(4)),
    ...
    private static void registerMagniaCrags(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, MAGNIA_TOWERS, get(context, EnderscapeConfiguredFeatures.MAGNIA_TOWER),
                ...
                BlockPredicateFilter.forPredicate(
                        allOf(
                                BlockPredicate.not(LithostitchedBlockPredicates.inStructure(8, 22)),
        ...
        PlacementUtils.register(context, MAGNIA_ARCHES, get(context, EnderscapeConfiguredFeatures.MAGNIA_ARCH),
                ...
                BlockPredicateFilter.forPredicate(
                        allOf(
                                BlockPredicate.not(LithostitchedBlockPredicates.inStructure(24)),
                                matchesBlocks(new Vec3i(0, 3, 0), AIR),
                                matchesBlocks(new Vec3i(0, 5, 0), AIR),
                                matchesBlocks(new Vec3i(0, 5, 3), AIR),
                                matchesBlocks(new Vec3i(0, 5, 5), AIR),
    ...
    private static void registerCelestialGrove(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, LARGE_CELESTIAL_CHANTERELLES, get(context, EnderscapeConfiguredFeatures.LARGE_CELESTIAL_CHANTERELLE),
                ...
                EnvironmentScanPlacement.scanningFor(Direction.DOWN, matchesBlocks(CELESTIAL_OVERGROWTH), ONLY_IN_AIR_PREDICATE, 12),
                BlockPredicateFilter.forPredicate(BlockPredicate.allOf(
                        BlockPredicate.not(LithostitchedBlockPredicates.inStructure(8, 36)),
                        matchesBlocks(new Vec3i(0, 1, 0), AIR)
                )),
    ...
    private static void registerCorruptBarrens(BootstrapContext<PlacedFeature> context) {
        PlacementUtils.register(context, MIRESTONE_PILLARS, get(context, EnderscapeConfiguredFeatures.MIRESTONE_PILLARS),
                ...
                CountOnEveryLayerPlacement.of(60),
                BiomeFilter.biome(),
                BlockPredicateFilter.forPredicate(BlockPredicate.not(LithostitchedBlockPredicates.inStructure(4))),
