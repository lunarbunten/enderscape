...
public class EnderscapeItemTags {
    ...
    public static final TagKey<Item> CANNOT_COMBINE_IN_ANVIL = register("cannot_combine_in_anvil");
    ...
    public static final TagKey<Item> END_HAVEN_CORE_FUELS = register("end_haven_core_fuels");
    ...
    public static final TagKey<Item> VOID_IMMUNE = register("void_immune");
