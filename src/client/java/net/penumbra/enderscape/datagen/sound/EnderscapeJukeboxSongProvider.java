...
import static net.penumbra.enderscape.registry.sound.EnderscapeJukeboxSongs.JUKEBOX_SONGS;

public class EnderscapeJukeboxSongProvider extends FabricDynamicRegistryProvider {

    public EnderscapeJukeboxSongProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> future) {
        super(output, future);
    }
