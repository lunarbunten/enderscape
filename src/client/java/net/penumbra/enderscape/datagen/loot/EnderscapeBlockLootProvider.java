...
public class EnderscapeBlockLootProvider extends FabricBlockLootSubProvider {
    ...
    public EnderscapeBlockLootProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> lookup) {
        super(output, lookup);
    }
    ...
    public void generate() {
        ...
        add(PURUBERRY_FLOWER, this::createShearsOnlyDrop);
        add(UNRIPE_PURUBERRY_BLOCK, this::createShearsOnlyDrop);
        add(RIPE_PURUBERRY_BLOCK, block -> createSilkTouchOrShearsDispatchTable(block, applyExplosionDecay(block, LootItem.lootTableItem(PURUBERRY)
        ...
        dropOther(VOID_LACHRYMA_CAULDRON, Blocks.CAULDRON);

        add(VOID_SHALE, block -> {
            LootItemBlockStatePropertyCondition.Builder isNatural = LootItemBlockStatePropertyCondition.hasBlockStateProperties(VOID_SHALE).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(StateProperties.NATURAL, true));
        ...
        dropSelf(CRACKED_END_STONE_BRICKS);
        dropSelf(OVERGROWN_END_STONE_BRICKS);
        dropSelf(OVERGROWN_END_STONE_BRICK_STAIRS);
        add(OVERGROWN_END_STONE_BRICK_SLAB, this::createSlabItemTable);
        dropSelf(OVERGROWN_END_STONE_BRICK_WALL);
        ...
        dropSelf(CRACKED_MIRESTONE_BRICKS);
        dropSelf(MIRESTONE_BRICK_STAIRS);
        add(MIRESTONE_BRICK_SLAB, this::createSlabItemTable);
        dropSelf(MIRESTONE_BRICK_WALL);
        dropSelf(OVERGROWN_MIRESTONE_BRICKS);
        dropSelf(OVERGROWN_MIRESTONE_BRICK_STAIRS);
        add(OVERGROWN_MIRESTONE_BRICK_SLAB, this::createSlabItemTable);
        dropSelf(OVERGROWN_MIRESTONE_BRICK_WALL);
