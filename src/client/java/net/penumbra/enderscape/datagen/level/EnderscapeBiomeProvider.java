...
import static net.penumbra.enderscape.registry.level.EnderscapeBiomes.BIOMES;

public class EnderscapeBiomeProvider extends FabricDynamicRegistryProvider {
    public EnderscapeBiomeProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> future) {
        super(output, future);
    }
